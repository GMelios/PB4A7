...
ggdag_classic(dag,node_size=40) + 
  theme_void_metro() + 
...
3. Variables you'd be really surprised to find out are relevant but just happen to be - and when you look into it there's a good reason it's relevant
